...
namespace TCRS.Database
{
    ...
    public partial class DataAccess
    {
        ...
        public void ChangeWarrentStatus(int reference_no, bool active_status, string connectionString)
        {
        ...
        private Wanted CreateWarrent(Wanted Wanted, string connectionString)
        {
        ...
        {
            var newWanted = CreateWarrent(Wanted, connectionString);
        ...
        public IEnumerable<Wanted_Vehicle> GetCitizenWarrentsByVehicle(int vehicle_id, string connectionString)
        {
            var sql = @$"SELECT * FROM (SELECT * FROM wanted_vehicle WHERE vehicle_id=@vehicle_id) as w
                LEFT JOIN wanted ON wanted.wanted_id =  w.wanted_idk";
        ...
        public IEnumerable<Wanted_Citizen> GetCitizenCitizenByVehicle(int citizen_id, string connectionString)
        {
            ...
            , new { citizen_id = citizen_id }, splitOn: "citizen_id, citizen_id");
